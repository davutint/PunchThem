...
namespace EmeraldAI
{
    ...
    public static class EmeraldAPI
    {
        ...
        {
            /// <summary>
            /// Knocks back the AI (like with the Knockback Module) based on the set parameters. The target must be an Emerald AI target.
            /// </summary>
            /// <param name="Direction"> The direction of the knockback.</param><param name="Target"> The target of the knockback.</param><param name="TargetICombat"> The ICombat component of the knockback.</param>
            /// <param name="KnockbackDuration"> Controls the how far back the target will be knocked back.</param>
            /// <param name="KnockbackDistance"> Controls the length (in seconds) of how long a target will take to reach its knockback destination.</param>
            /// <param name="MovementDelay"> Controls the length (in seconds) of how long it takes an Emerald AI target to resume its movement after being knocked back.</param>
